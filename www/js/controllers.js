...
.controller('catCtrl', ["$scope", "$stateParams", "Items", function ($scope, $stateParams, Items) {
...
.controller('listOfBookCtrl', ["$scope", "$stateParams", "Items", function ($scope, $stateParams, Items) {
    ...
    .controller('BookDetailsCtrl', ["$scope", "$stateParams", "Items", function ($scope, $stateParams, Items) {
